      ...
      <div className="w-full max-w-2xl bg-white rounded-2xl shadow-2xl p-8">
            ...
            todos.map((todo) => (
              ...
              >
                ...
                <button
                  ...
                  className="opacity-0 group-hover:opacity-100 text-red-500 hover:text-red-700 font-semibold transition-opacity"
                >
                  Delete
                </button>
              </div>
        ...
        {todos.some(todo => todo.completed) && (
          <button
            ...
            className="mt-6 w-full py-2 text-gray-500 hover:text-red-500 font-medium transition-colors"
          >
